...
```{r}
dp1 = get_data_for_plotting(dfWCyn)
...
```{r}
dfWCyn$YrStart = as.numeric(dfWCyn$YrStart) 
dfTS9J2yn$YrStart = as.numeric(dfTS9J2yn$YrStart) 
dfBAJ2yn$YrStart = as.numeric(dfBAJ2yn$YrStart) 

hist(dfWCyn$YrStart, ylim=c(0,900), col="lightblue", breaks = 15, main="Year First Cited")
...
hist(dfWCyn$`Publication Year`, ylim=c(0,900), breaks = 15, main="Year First Published")
